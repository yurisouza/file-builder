...
namespace FileBuilder.Core.Mapping.TypeConverter
{
    public class TypeConverterProvider : ITypeConverterProvider
    {
        ...
        public TypeConverterProvider Add<TTargetType>(ITypeConverter<TTargetType> typeConverter)
        {
            ...
            {
                throw new Exception($"Duplicate TypeConverter registration for Type {typeConverter.TargetType}");
            }
        ...
        public ITypeConverter<TTargetType> Resolve<TTargetType>()
        {
            ...
            {
                throw new Exception($"No TypeConverter registered for Type {targetType}");
            }
